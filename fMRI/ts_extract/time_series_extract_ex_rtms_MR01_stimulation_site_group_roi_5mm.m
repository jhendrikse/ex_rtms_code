...
rois_dir = '/projects/kg98/Josh/BIDS_data/MR01/ROIs/stimulation_site/group/10mm_medial/';
...
system(['mkdir stim_site_group_roi_10mm']) ;
...
system(['mv ',savefile,'.mat',' stim_site_group_roi_10mm']) ;
...
thespmdir = ([epidir,'stim_site_group_roi_10mm/','spm','_',roifiles(i).name(1:end-4)]) ;

% Define input directory for time series and regressor file
roi_ts_regs_dir = ([epidir,'stim_site_group_roi_10mm/']) ;
