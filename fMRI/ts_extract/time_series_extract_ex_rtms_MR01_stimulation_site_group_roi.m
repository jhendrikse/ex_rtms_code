function [] = time_series_extract_ex_rtms_MR01_stimulation_site_group_roi
...
rois_dir = '/projects/kg98/Josh/BIDS_data/MR01/ROIs/stimulation_site/group/5mm/';
...
system(['mkdir stim_site_group_roi']) ;
...
system(['mv ',savefile,'.mat',' stim_site_group_roi']) ;
...
thespmdir = ([epidir,'stim_site_group_roi/','spm','_',roifiles(i).name(1:end-4)]) ;

% Define input directory for time series and regressor file
roi_ts_regs_dir = ([epidir,'stim_site_group_roi/']) ;
