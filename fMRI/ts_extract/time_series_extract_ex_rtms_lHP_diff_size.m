function [] = time_series_extract_ex_rtms_lHP_diff_size
...
rois_dir = '/projects/kg98/Josh/BIDS_data/MR01/ROIs/ROI_test_diff_size/';
...
system(['mv ',savefile,'.mat',' lHP_diff_size']) ;
...
thespmdir = ([epidir,'lHP_diff_size/','spm','_',roifiles(i).name(1:end-4)]) ;

% Define input directory for time series and regressor file
roi_ts_regs_dir = ([epidir,'lHP_diff_size/']) ;
