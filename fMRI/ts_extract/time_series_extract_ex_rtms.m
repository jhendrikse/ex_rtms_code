function [] = time_series_extract_ex_rtms

% This script will perform ROI time series extraction looping over BIDS formatted subjects.
%
...
%  Josh Hendrikse, Chao Suo, & James Coxon, Monash University, 2018/9.
...
% script below to avoid conflict with spm routines - can be used to create
% ROIs within script 
