...
% load('/projects/kg98/Josh/BIDS_data/2nd_level_rs_fmri/fishers_z/con_paths_fishers_z_HP_ind.mat') % load array containing filepaths to fisher z con maps for hp seed individual coordinates
...
output_name = ['/projects/kg98/Josh/BIDS_data/2nd_level_rs_fmri/fishers_z/HP_seed_SMA_stim_post-pre_NO_CSF_WM_REG/',char(extractBetween(id,'MR01_','_HP')),'_HP_seed_SMA_stim_post-pre.img'] ; % generate new subject specific filename
