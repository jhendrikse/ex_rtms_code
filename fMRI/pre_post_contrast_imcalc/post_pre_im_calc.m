...
load('/projects/kg98/Josh/BIDS_data/2nd_level_rs_fmri/fishers_z/con_paths_fishers_z_parietal_stim_site.mat') % load array containing filepaths to fisher z con maps for hp seed individual coordinates

% create two column array of pre and post con images 
 
MR01 = inputs(1:2:end,1) ; % time point 1 scans
MR02 = inputs(2:2:end,1) ; % time point 2 scans

con_filenames = [MR01,MR02] ; % array containing filepaths for both scan time points
