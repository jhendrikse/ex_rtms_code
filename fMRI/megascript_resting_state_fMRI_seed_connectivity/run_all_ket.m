...
% where spm is
spmdir = '/Users/alexfornito/Desktop/prepro_scripts/scripts/spm8/';
addpath(genpath(spmdir));

% where REST is
addpath(genpath('/Applications/MATLAB_toolboxes/REST_V1.8PRE_120905/'))
...
addpath(genpath('/Users/alexfornito/Desktop/prepro_scripts/scripts/'))

% set FSL environments 
fsldir = '/Applications/fsl/bin/'; % directory where fsl is
...
rawdir = ['/Users/alexfornito/Desktop/prepro_scripts/data/ketamine/',subject,'/epi/']; % where the unprocessed epi 4d files are
...
t1dir = ['/Users/alexfornito/Desktop/prepro_scripts/data/ketamine/',subject,'/t1/']; 
% name of t1 file.
t1name = ['t1.nii'];  
...
roidir = '/Users/alexfornito/Desktop/prepro_scripts/rois/left/';   
...
% realignment
spatial_prepro_4d([rawdir,epi4d],[t1dir,t1name],mni_template,voxdim,N);  
