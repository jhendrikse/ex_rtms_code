...
% where spm is
spmdir = '/Users/joshua_hendrikse/Documents/MATLAB/megascript/spm8/';
...
segment_t1_invmat([t1dir,t1name],spmdir);
...
if ~isempty(kernel)
    ...
    smooth_epi([rawdir,'wepi.nii'],kernel,N);
