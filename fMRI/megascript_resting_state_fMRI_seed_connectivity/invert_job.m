...
%-----------------------------------------------------------------------
matlabbatch{1}.spm.spatial.normalise.write.subj.matname = {'/Users/amy/Desktop/fMRI_analysis/data/subject/t1/t1_seg_inv_sn.mat'};
matlabbatch{1}.spm.spatial.normalise.write.subj.resample = {'/Users/amy/Desktop/fMRI_analysis/data/subject/epi/spm/stimclust.img,1'};
...
matlabbatch{2}.spm.spatial.coreg.write.ref = {'/Users/amy/Desktop/fMRI_analysis/data/subject/t1/t1.nii,1'};
