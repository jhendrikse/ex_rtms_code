...
PROJDIR=/projects/kg98/Josh/BIDS_data/MR02
...
REST=Rest_fMRI_3mm
STUDY=MRH078_ #<change to your study ID>
SESSION=_MR02 #can change to download different sessions 
...
SUBJIDS="DJ03 006 007	008	009	010	011	012	015	017	018	019	020	021	022	023	024	026	027	028	029	030	031	PKA30	AR31	CD32	DJG33	ST34	TG35	AY36	JT37	CR38	EH39	NU40	JC41	SA42	PL43	ID44" ##$/projects/kg98/Josh
